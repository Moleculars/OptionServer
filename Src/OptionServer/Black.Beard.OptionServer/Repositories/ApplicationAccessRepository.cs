...
namespace Bb.OptionServer.Repositories
{
    ...
    public class ApplicationAccessRepository
    {
        ...
        public ApplicationAccessRepository(DtoSqlManager dtoManager)
        {
            _dtoManager = dtoManager;
        }

        public bool Insert(ApplicationAccessTable item)
        {
            bool result;
        ...
        public bool Update(ApplicationAccessTable item)
        {
            bool result;
        ...
        public IEnumerable<ApplicationAccessTable> ReadByUser(Guid userId)
        {

            var users = _dtoManager.Select<ApplicationAccessTable>(c => c.UserId == userId);

            foreach (ApplicationAccessTable user in users)
                yield return user;

        }

        public IEnumerable<ApplicationAccessTable> ReadByApplication(Guid userId)
        {

            var users = _dtoManager.Select<ApplicationAccessTable>(c => c.ApplicationId == userId);
