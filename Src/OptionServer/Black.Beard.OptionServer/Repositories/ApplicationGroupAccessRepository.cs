...
namespace Bb.OptionServer.Repositories
{
    ...
    public class ApplicationGroupAccessRepository
    {

        public ApplicationGroupAccessRepository(DtoSqlManager dtoManager)
        {
            _dtoManager = dtoManager;
        }

        public bool Insert(ApplicationGroupAccessTable item)
        {
            bool result;
        ...
        public bool Update(ApplicationGroupAccessTable item)
        {
            bool result;
        ...
        public IEnumerable<ApplicationGroupAccessTable> ReadByUser(Guid userId)
        {

            var users = _dtoManager.Select<ApplicationGroupAccessTable>(c => c.UserId == userId);

            foreach (ApplicationGroupAccessTable user in users)
                yield return user;

        }

        public IEnumerable<ApplicationGroupAccessTable> ReadByGroup(Guid groupId)
        {

            var users = _dtoManager.Select<ApplicationGroupAccessTable>(c => c.ApplicationGroupId == groupId);
        ...
        private DtoSqlManager _dtoManager;
